        ...
        <div>
          ...
          <div className="mt-6 bg-cream-100 border border-cream-200 rounded-lg p-4 text-sm text-gray-600">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>แอดมินตรวจสอบสลิปและยืนยันการชำระเงิน</li>
              <li>กรุณาเข้ามาตรวจสอบสถานะที่หน้านี้อีกครั้ง (แอดมินยืนยันการชำระเงินภายในภายใน 24 ชม.)</li>
              <li>ดาวน์โหลดไฟล์ข้อสอบและเฉลยได้ทันทีในหน้าคลังข้อสอบของฉัน</li>
            </ol>
          </div>
        </div>
      </div>
